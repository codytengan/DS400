...
##
## Your answer:
##the mean goes up by .001, bounds are closer together
##
## ------------------------------------------------------------
...
##
## Your answer:
##posterior and likelihood are the same
##the data determins posterior
## ------------------------------------------------------------
...
##
## Your answer:
##the posterier is closer to the priors because data is reletively the same. it takes a drastic diffrence to change priors
##
## ------------------------------------------------------------
...
##
## Your answer:
##because a frequenitist variable is a single variable
##
## ------------------------------------------------------------
...
##
## Your answer:
##posterior is closer to the data because not enough new data and the data is too different 
##
## ------------------------------------------------------------
...
##
## Your answer:
##drastic shifts in data will be very visable but smaller subtle shifts that agree with your past data will be harder to catch
##
## ============================================================
